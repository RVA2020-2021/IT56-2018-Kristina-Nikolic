...
import { DEPARTMAN_URL, DEPARTMAN_ZA_FAKULTET_URL } from '../app.constants';
import { Departman } from '../models/Departman/departman';
...
export class DepartmanService {
  ...
  public getDepartmaniZaFakultet(idFakulteta: number): Observable<any> {
    return this.httpClient.get(`${DEPARTMAN_ZA_FAKULTET_URL}/${idFakulteta}`);
  }
