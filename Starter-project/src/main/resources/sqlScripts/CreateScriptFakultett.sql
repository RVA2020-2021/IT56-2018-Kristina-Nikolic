...
CREATE INDEX idfk_departman_fakultet ON departman(fakultet);
CREATE INDEX idfk_student_status ON student(status);
CREATE INDEX idfk_student_departman ON student(departman);
